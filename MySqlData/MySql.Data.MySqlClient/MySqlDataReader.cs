	...
	public sealed class MySqlDataReader : MarshalByRefObject, IDisposable, IEnumerable, IDataReader, IDataRecord
	{
		...
		public void Close()
		{
			...
			try
			{
				...
				if ((this.commandBehavior & 32) != null)
				{
		...
		public DataTable GetSchemaTable()
		{
			...
			if (this.fields != null && this.fields.Length != 0)
			{
				...
				dataTable.get_Columns().Add("ColumnName", typeof(string));
				dataTable.get_Columns().Add("ColumnOrdinal", typeof(int));
				dataTable.get_Columns().Add("ColumnSize", typeof(int));
				dataTable.get_Columns().Add("NumericPrecision", typeof(int));
				dataTable.get_Columns().Add("NumericScale", typeof(int));
				dataTable.get_Columns().Add("IsUnique", typeof(bool));
				dataTable.get_Columns().Add("IsKey", typeof(bool));
				DataColumn dataColumn = dataTable.get_Columns()["IsKey"];
				dataColumn.set_AllowDBNull(true);
				dataTable.get_Columns().Add("BaseCatalogName", typeof(string));
				dataTable.get_Columns().Add("BaseColumnName", typeof(string));
				dataTable.get_Columns().Add("BaseSchemaName", typeof(string));
				dataTable.get_Columns().Add("BaseTableName", typeof(string));
				dataTable.get_Columns().Add("DataType", typeof(Type));
				dataTable.get_Columns().Add("AllowDBNull", typeof(bool));
				dataTable.get_Columns().Add("ProviderType", typeof(int));
				dataTable.get_Columns().Add("IsAliased", typeof(bool));
				dataTable.get_Columns().Add("IsExpression", typeof(bool));
				dataTable.get_Columns().Add("IsIdentity", typeof(bool));
				dataTable.get_Columns().Add("IsAutoIncrement", typeof(bool));
				dataTable.get_Columns().Add("IsRowVersion", typeof(bool));
				dataTable.get_Columns().Add("IsHidden", typeof(bool));
				dataTable.get_Columns().Add("IsLong", typeof(bool));
				dataTable.get_Columns().Add("IsReadOnly", typeof(bool));
				int num = 1;
				for (int i = 0; i < this.fields.Length; i++)
				{
					...
					dataRow.set_Item("ColumnOrdinal", num++);
					dataRow.set_Item("ColumnSize", mySqlField.IsTextField ? (mySqlField.ColumnLength / mySqlField.MaxLength) : mySqlField.ColumnLength);
					...
					dataRow.set_Item("IsLong", mySqlField.IsBlob && mySqlField.ColumnLength > 255);
		...
		public bool NextResult()
		{
			...
			{
				if (this.connection.State != null && this.connection.State != 1)
				{
					this.connection.SetState(1);
				}
			}
