...
namespace MySql.Data.MySqlClient
{
	...
	public sealed class MySqlDataAdapter : DbDataAdapter, IDbDataAdapter, IDataAdapter
	{
		...
		public event MySqlRowUpdatingEventHandler RowUpdating
		{
			add
			{
				base.Events.AddHandler(MySqlDataAdapter.EventRowUpdating, value);
			}
			remove
			{
				base.Events.RemoveHandler(MySqlDataAdapter.EventRowUpdating, value);
			}
		}
		...
		public event MySqlRowUpdatedEventHandler RowUpdated
		{
			add
			{
				base.Events.AddHandler(MySqlDataAdapter.EventRowUpdated, value);
			}
			remove
			{
				base.Events.RemoveHandler(MySqlDataAdapter.EventRowUpdated, value);
			}
		}
