...
namespace MySql.Data.MySqlClient
{
	...
	public sealed class MySqlCommandBuilder : Component
	{
		...
		public static void DeriveParameters(MySqlCommand command)
		{
            ...
            foreach(Object o in procedure) { 
				MySqlParameter value = (MySqlParameter)o;
		...
		private void GenerateSchema()
		{
			...
			try
			{
				MySqlDataReader mySqlDataReader = this._adapter.SelectCommand.ExecuteReader((CommandBehavior)6);
		...
		private static void SetParameterValues(MySqlCommand cmd, DataRow dataRow)
		{
			foreach (Object o in cmd.Parameters)
			{
				...
				if (mySqlParameter.SourceVersion == (DataRowVersion)256)
				{
					mySqlParameter.Value = dataRow[mySqlParameter.SourceColumn, (DataRowVersion)256];
				}
				else
				{
					mySqlParameter.Value = dataRow[mySqlParameter.SourceColumn, (DataRowVersion)512];
				}				
			}
		}
