...
namespace MySql.Data.MySqlClient
{
	...
	public sealed class MySqlParameter : MarshalByRefObject, ICloneable, IDbDataParameter, IDataParameter
	{
		...
		private ParameterDirection direction = (ParameterDirection)1;
		...
		private DataRowVersion sourceVersion = (DataRowVersion)512;
		...
		{
			this.size = size;
			this.direction = (ParameterDirection)1;
			this.sourceColumn = sourceColumn;
			this.sourceVersion = (DataRowVersion)512;
		}
		...
		private void SetMySqlDbType(MySqlDbType mySqlDbType)
		{
			...
			case MySqlDbType.Decimal:
				this.dbType = (DbType)7;
				return;
			case MySqlDbType.Byte:
				this.dbType = (DbType)14;
				return;
			...
			case MySqlDbType.Int24:
				this.dbType = (DbType)11;
				return;
			case MySqlDbType.Float:
				this.dbType = (DbType)15;
				return;
			...
			case MySqlDbType.Datetime:
				this.dbType = (DbType)6;
				return;
			case MySqlDbType.Int64:
				this.dbType = (DbType)12;
				return;
			case MySqlDbType.Date:
			case MySqlDbType.Year:
			case MySqlDbType.Newdate:
				this.dbType = (DbType)5;
				return;
			case MySqlDbType.Time:
				this.dbType = (DbType)17;
				return;
			...
			default:
				...
				case MySqlDbType.VarChar:
					this.dbType = (DbType)16;
					return;
				case MySqlDbType.TinyBlob:
				case MySqlDbType.MediumBlob:
				case MySqlDbType.LongBlob:
				case MySqlDbType.Blob:
					this.dbType = (DbType)13;
					return;
				case MySqlDbType.Char:
					this.dbType = (DbType)23;
					break;
				default:
					switch (mySqlDbType)
					{
					case MySqlDbType.UByte:
						this.dbType = (DbType)2;
						return;
					case MySqlDbType.UInt16:
		...
		private void SetDbType(DbType dbType)
		{
			...
			case 3:
			case 14:
				this.mySqlDbType = (((int)dbType == 2) ? MySqlDbType.UByte : MySqlDbType.Byte);
				return;
			case 4:
			case 7:
		...
		private void SetTypeFromValue()
		{
			if (this.paramValue != null)
			{
				if (this.paramValue != DBNull.Value)
				{
					...
					{
						switch ((int)Type.GetTypeCode(this.paramValue.GetType()))
						{
						case 5:
							this.DbType = (DbType)14;
							goto IL_155;
