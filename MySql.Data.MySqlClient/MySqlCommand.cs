...
namespace MySql.Data.MySqlClient
{
	...
	public sealed class MySqlCommand : Component, IDbCommand, IDisposable, ICloneable
	{
		...
		[Category("Data"), Description("The parameters collection"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		...
		{
			if (reader != null && ((int)reader.Behavior & 1) != 0 && this.lastResult != null)
			{
				return null;
			}
		...
		private void CheckState()
		{
			if (this.connection != null)
			{
				if ((int)this.connection.State == 1)
				{
					...
					if ((int)this.CommandType == 4 && !this.connection.driver.Version.isAtLeast(5, 0, 0))
					{
		...
		object ICloneable.Clone()
		{
			...
			foreach (Object o in this.parameters) { 
				...
				mySqlCommand.Parameters.Add(((ICloneable)mySqlParameter).Clone());
			}
			return mySqlCommand;
		}
	}
