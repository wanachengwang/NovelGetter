	...
	internal sealed class Deflate
	{
		...
		internal bool _tr_tally(int dist, int lc)
		{
			...
			if (dist == 0)
			{
				short[] array;
				IntPtr intPtr;
				(array = this.dyn_ltree)[(int)(intPtr = (IntPtr)(lc * 2))] = (short)(array[(int)intPtr] + 1);
			}
			else
			{
				this.matches++;
				...
				short[] array;
				IntPtr intPtr;
				(array = this.dyn_ltree)[(int)(intPtr = (IntPtr)((Tree._length_code[lc] + 256 + 1) * 2))] = (short)(array[(int)intPtr] + 1);
				(array = this.dyn_dtree)[(int)(intPtr = (IntPtr)(Tree.d_code(dist) * 2))] = (short)(array[(int)intPtr] + 1);
			}
		...
		internal int longest_match(int cur_match)
		{
			...
			do
			{
				...
				if ((cur_match = ((int)this.prev[cur_match & num6] & 65535)) <= num4)
				{
					break;
				}
			}
